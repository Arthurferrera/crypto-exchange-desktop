...
public class FrmUsuarios extends JFrame {
	...
	public FrmUsuarios(int idUsuario) {
		...
		btnNovo.setToolTipText("Clique para adicionar uma musica");
		...
		btnExcluir.setToolTipText("Clique para excluir uma muisca");
		...
		btnEditar.setToolTipText("Clique para editar uma musica");
